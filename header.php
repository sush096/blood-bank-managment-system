...
body{
    ...
    ul li a:hover{color: #000 !important; font-weight:600; text-decoration:none;border-bottom:2px solid #ED2553; }
...
<!-- <div id="result" style="position:fixed;top:300; right:500;z-index: 3000;width:350px;background:white;"></div> -->
    <!-- <div id="result" style=" margin:0px auto; position:fixed; top:150px;right:750px; background:white;  z-index: 3000;"></div> -->

        <nav class="navbar navbar-expand-lg navbar-light fixed-top mb-5" id="navBar">
          
            <a class="navbar-brand ml-5" href="index.php">Blood Bank</a>
            <?php if (isset($_SESSION['login_user'])) {
                        $username=$_SESSION['login_user'];
                        $encode = base64_encode($username); 
                        echo "<a href=\"pateint.php?id=$encode\"> Welcome, $username </a></li>";
                      }
                        ?>
                ...
                <li class="nav-item">
                  ...
                  <?php
                    ...
                    {
                    ?>  
                    <a class="btn btn-outline-danger my-5 my-sm-0" name="logout" href="login.php">Log In</a>
                    <?php
                    }
                    ?>
                    </form>
